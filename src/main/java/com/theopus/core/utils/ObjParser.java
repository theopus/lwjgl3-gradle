...
public class ObjParser {
    ...
    public static Result parse(String fileName) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(ObjParser.class.getClassLoader().getResourceAsStream(fileName)))) {
            String line;
    ...
    private static Result reorderLists(List<Vector3f> posList, List<Vector2f> textCoordList,
        ...
        Result mesh = new Result(posArr, textCoordArr, normArr, indicesArr);
        return mesh;
    }
